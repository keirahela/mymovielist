...
function LoginPage() {
  ...
  return (
    <div className="login-container">
      ...
      <button className="discord-button mt-2 mb-2" onClick={() => window.location.href = 'https://discord.com/oauth2/authorize?client_id=1125638027100831754&response_type=code&redirect_uri=http%3A%2F%2Flocalhost%3A5173%2Fapi%2Fdiscord%2Fcallback&scope=identify+guilds'}>
